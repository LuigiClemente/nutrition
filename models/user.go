...
type RequestedMeal struct {
	...
	StarterMealType int  `json:"starter_meal_type" binding:"required"`
	MainMealType    int  `json:"main_meal_type" binding:"required"`
	DessertMealType int  `json:"dessert_meal_type" binding:"required"`
