...
(1, 9),   -- Grilled Chicken Salad tagged as 'Low Calorie'
(1, 15),  -- Grilled Chicken Salad tagged as 'Organic'
(2, 2),   -- Vegetable Stir Fry tagged as 'Vegan'
(2, 7),   -- Vegetable Stir Fry tagged as 'Low Carb'
(2, 9),   -- Vegetable Stir Fry tagged as 'Low Calorie'
(2, 12),  -- Vegetable Stir Fry tagged as 'Paleo'
(2, 16),  -- Vegetable Stir Fry tagged as 'Organic'
(3, 1),   -- Quinoa Salad tagged as 'Healthy'
(3, 3),   -- Quinoa Salad tagged as 'Gluten-Free'
(3, 7),   -- Quinoa Salad tagged as 'Low Carb'
(3, 9),   -- Quinoa Salad tagged as 'Low Calorie'
(3, 12),  -- Quinoa Salad tagged as 'Paleo'
...
(12, 18); -- Stuffed Mushrooms tagged as 'Nut-Free'
